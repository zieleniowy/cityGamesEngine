...
export default withSnackbar((props)=>{
    ...
    return (
            <Container maxWidth="sm">
                    <BorderedPanel color="primary" title="Przelej gotówkę">
                        <Box p={2}>
                            <Grid container spacing={2}>
                                <Grid item xs={12} sm={6}>
                                    <PlayerSelect label={window.i18n.global.player} onChange={setPlayer} player={player} />
                                </Grid> 
                                <Grid item xs={12} sm={6}>
                                    <TextField inputRef={r=>ref=r} label={window.i18n.global.amount} defaultValue={0} />
